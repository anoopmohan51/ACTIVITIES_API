...
interface ExperienceImageAttributes {
    id?: number;
...
export class ExperienceImage extends Model<ExperienceImageAttributes> {
    ...
    static initialize(sequelize: Sequelize) {
        this.init(
            ...
            {
                sequelize,
                tableName: 'experienceImages',
                modelName: 'ExperienceImage',
            }
        );
    }
}
